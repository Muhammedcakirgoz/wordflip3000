...
import com.example.learning.utils.DatabaseResetHelper
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun saveLanguageSetting(language: String) {
        ...
        com.example.learning.utils.LocaleHelper.setLocale(this, language)
    ...
    companion object {
        const val THEME_CHANGED_ACTION = "com.example.uygulamaproje.THEME_CHANGED"
